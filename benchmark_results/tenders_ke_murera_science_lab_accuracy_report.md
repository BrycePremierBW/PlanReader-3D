...
| `masonry_external_walling` | 150mm thick natural stone external walling | `measurable_from_drawings` | 132.00 | 147.84 | SM | +15.84 | 12.0% | `within_20_percent` | Sheet Elevations E-01/E-03 (p. 219) |
...
| `brick_vents` | 250mm x 150mm precast/brick vents | `measurable_from_drawings` | 12.00 | 9.00 | NO | -3.00 | 25.0% | `gross_mismatch` | Sheet Elevations E-01/E-03 (p. 219) |
...
| `external_key_pointing` | External key pointing to exposed stone/block masonry | `hallucinated` | - | 147.84 | SM | - | - | `hallucinated_item` | Sheet E-04 (p. 220) |
...
- **`brick_vents`** (250mm x 150mm precast/brick vents): Expected `12.0`, Extracted `9.0` (25.0% error). Comparison evaluated against 12.0 NO
...
- **`external_key_pointing`** (External key pointing to exposed stone/block masonry): Extracted `147.84 SM` with no corresponding BOQ entry.
