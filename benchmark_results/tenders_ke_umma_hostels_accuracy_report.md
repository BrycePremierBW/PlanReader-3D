...
- **Evaluation Timestamp**: `2026-09-09T11:32:18.662232+00:00`
...
| :--- | :--- | :--- |
| **Overall Accuracy (<= 5% tol)** | **`100.0%`** | Combined exact matches and within 5% tolerance |
| **Strict Exact Accuracy** | **`100.0%`** | Zero-tolerance exact numerical matches only |
...
| Exact Matches | `15` | Exactly matched quantities |
...
| Missed Items | `0` | Measurable items present in BOQ but missing in extraction |
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| `UUH-WD1` | WD 01 - window panel, 1800x2200mm high, horizontal sliding panels with U-channel frame (4-bed rooms, Locker rooms, Games Room, PWD room) | `schedule_extractable` | 172.00 | 172.00 | NO | +0.00 | 0.0% | `exact_match` | Sheet TI-UUH/25/11 rev.02 (Window and Door Schedule) (p. 160) |
| `UUH-WD2` | WD 02 - window panel, 1800x1800mm high, horizontal sliding panels (All Washrooms) | `schedule_extractable` | 184.00 | 184.00 | NO | +0.00 | 0.0% | `exact_match` | Sheet TI-UUH/25/11 rev.02 (Window and Door Schedule) (p. 160) |
| `UUH-WD3` | WD 03 - window panel, 900x900mm high, horizontal sliding panels (Laundry area) | `schedule_extractable` | 4.00 | 4.00 | NO | +0.00 | 0.0% | `exact_match` | Sheet TI-UUH/25/11 rev.02 (Window and Door Schedule) (p. 160) |
