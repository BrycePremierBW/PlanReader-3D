...
- **Evaluation Timestamp**: `2026-09-09T05:35:47.460466+00:00`
...
| :--- | :--- | :--- |
| **Overall Accuracy (<= 5% tol)** | **`60.0%`** | Combined exact matches and within 5% tolerance |
| **Strict Exact Accuracy** | **`60.0%`** | Zero-tolerance exact numerical matches only |
...
| Exact Matches | `9` | Exactly matched quantities |
...
| Hallucinated Items | `3` | Items extracted but absent from drawing / BOQ |
...
| `D4` | D - 04 card schedule, explicit Overall Quantity | `hallucinated` | - | 308.00 | NO | - | - | `hallucinated_item` | Sheet N/A (p. 161) |
| `D9` | D - 09 card schedule, explicit Overall Quantity | `hallucinated` | - | 1.00 | NO | - | - | `hallucinated_item` | Sheet N/A (p. 161) |
| `D11` | D - 11 card schedule, explicit Overall Quantity | `hallucinated` | - | 1.00 | NO | - | - | `hallucinated_item` | Sheet N/A (p. 162) |
...
- **`D4`** (D - 04 card schedule, explicit Overall Quantity): Extracted `308.0 NO` with no corresponding BOQ entry.
- **`D9`** (D - 09 card schedule, explicit Overall Quantity): Extracted `1.0 NO` with no corresponding BOQ entry.
- **`D11`** (D - 11 card schedule, explicit Overall Quantity): Extracted `1.0 NO` with no corresponding BOQ entry.
